...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileMongoDBAtlasDatabase{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MongoDBAtlasDatabase
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &knappekv1alpha1.MongoDBAtlasDatabase{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMongoDBAtlasDatabase) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set MongoDBAtlasDatabase instance as the owner and controller
